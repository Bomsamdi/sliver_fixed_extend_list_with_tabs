...
class SliverHeaderWithSliverBodyParentData extends SliverPhysicalParentData
...
/// The RenderObject that handles laying out and painting the children of [SliverHeaderWithSliverBodyWidget]
class RenderSliverHeaderWithSliverBodyWidget extends RenderSliver
    with
        ContainerRenderObjectMixin<RenderObject,
            SliverHeaderWithSliverBodyParentData>,
        RenderSliverHelpers {
  ...
  void setupParentData(RenderObject child) {
    if (child.parentData is! SliverHeaderWithSliverBodyParentData) {
      child.parentData = SliverHeaderWithSliverBodyParentData();
    }
  }
  ...
  double? _layoutChildSequence({
    ...
    for (final child in _children) {
      final parentData =
          child.parentData as SliverHeaderWithSliverBodyParentData;
  ...
  SliverHeaderWithSliverBodyParentData layoutChild(
  ...
  void setBoxChildParentData(
    ...
    final SliverHeaderWithSliverBodyParentData childParentData =
        child.parentData! as SliverHeaderWithSliverBodyParentData;
  ...
  bool hitTestChildren(
    ...
    for (final child in _children.where((c) =>
        (c.parentData as SliverHeaderWithSliverBodyParentData)
            .geometry
            .visible)) {
      if (child is RenderSliver) {
        final paintOffset =
...
extension on RenderObject {
  SliverConstraints? get sliverConstraints =>
      (parentData as SliverHeaderWithSliverBodyParentData).constraints;
}
